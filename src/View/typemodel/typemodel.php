<section class="section">
    <div class="section-header">
        <h1>Type/Model (COST CENTER)</h1>
    </div>

    <div class="section-body">
        <b>Type/Model (COST CENTER) Expenses</b>
    </div>
